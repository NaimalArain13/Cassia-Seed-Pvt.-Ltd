...
export const CROPS: Crop[] = [
  ...
  { id: 'tinda_gourd',  en: 'Tinda Gourd',   ur: 'ٹینڈا',       sowingTime: 'March – April, June – July',  sowingMonths: [3,4,6,7],       seasons: ['summer'],           yieldPerPlant: '1 kg',     firstHarvest: '50–60 days'   },
